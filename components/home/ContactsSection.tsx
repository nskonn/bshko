          ...
          <div className="col-span-12 md:col-span-10 md:col-start-2 lg:col-span-8 lg:col-start-3">
              ...
              <form className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="space-y-1">
                    <label className="text-base font-semibold text-slate-700 ml-1">Имя</label>
                  ...
                  <div className="space-y-1">
                    <label className="text-base font-semibold text-slate-700 ml-1">Фамилия</label>
                ...
                <div className="space-y-1">
                  <label className="text-base font-semibold text-slate-700 ml-1">Email</label>
                ...
                <div className="space-y-1">
                  <label className="text-base font-semibold text-slate-700 ml-1">Сообщение</label>
            ...
            <div className="flex justify-center">
              <a href="mailto:bshko@denis-samarin.ru" className="inline-flex items-center gap-3 px-6 py-3 bg-slate-50 rounded-full hover:bg-slate-100 transition-all group border border-slate-100">
                ...
                <span className="text-base font-bold text-slate-600 group-hover:text-brand-600 transition-colors">Свяжитесь с нами: bshko@denis-samarin.ru</span>
              </a>
            </div>
