...
const TeachersSection = () => {
  ...
  return (
    <section className="py-24 bg-[#FDFBF7]" id="teachers">
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          <span className="text-amber-600 font-bold uppercase tracking-wider text-sm mb-3 block">Наша команда</span>
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-heading">Преподаватели</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teachers.map((teacher, index) => (
            <div key={index} className="bg-white rounded-[2rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-slate-100 flex flex-col">
              ...
              <div className="p-6 flex-grow flex flex-col gap-4">
                ...
                <div className="space-y-3">
                  ...
                  {/* Location Block */}
                  <div className="flex gap-3">
                    <div className="mt-1 w-5 h-5 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center shrink-0">
